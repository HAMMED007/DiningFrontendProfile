    ...
    return (
        <>
            ...
            <div>
                            ...
                            <div className="booking">
                                ...
                                <div className="booking_top">
                                    <div className="booking_form">
                                        ...
                                        <div className="mb-3">
                                            <button className="btn btn primary__btn  w-100 mt-4 btn cevent" onClick={createEvent}>Create event</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                {/* Modal to display the event creation success message */}
                <Modal show={eventCreated} onHide={() => setEventCreated(false)}>
                    ...
                    <Modal.Footer>
                        <Button variant="secondary" onClick={() => setEventCreated(false)}>Close</Button>
                    </Modal.Footer>
                </Modal>
            </div>
        </>
